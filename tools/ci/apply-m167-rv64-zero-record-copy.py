...
new = """    /* M167_ZERO_RECORD_COPY: GNU empty records are addressable semantic
...
if count != 1:
    raise SystemExit(f"M167 zero-record copy: expected 1 capability seam, got {count}")

text = text.replace(old, new, 1)
PATH.write_text(text)
print("M167_ZERO_RECORD_COPY_APPLIED")
