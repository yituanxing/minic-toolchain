...
'''
helper = r'''static bool local_declarator_starts_function_pointer(const MinicParser *parser) {
    MinicParser probe;
...
parse_local_declarator(MinicParser *parser, MinicType base_type, bool is_register_storage) {
'''
text = replace_once(text, anchor, helper, "local function-pointer lookahead owner")
