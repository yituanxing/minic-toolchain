...
# Resolve promoted members recursively, then lower a promoted access to an ordinary sequence
# of member/address expressions so RV64 layout/codegen has only one representation to handle.
