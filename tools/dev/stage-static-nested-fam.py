...
printf '%s\n' 'PASS compiler/c0/static_nested_flexible_array_initializer zero-slot-fam + post-fam relocation'
'''
...
print("staged static nested flexible-array zero-slot semantics")
