...
if ! grep -F ":100:15:" "$work/minic.stderr" >/dev/null ||
   ! grep -F "expected ';' after expression" \
...
printf '%s\n' \
    "PASS external/tiny-aes-c frontier=AddRoundKey-parenthesized-dereference-subscript diagnostic=$frontier"
