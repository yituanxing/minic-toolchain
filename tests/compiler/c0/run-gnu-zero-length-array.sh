...
printf '%s\n' 'PASS compiler/c0/gnu_zero_length_array extern=1 incomplete-to-zero=1 sizeof=0 decay=1 type-identity=complete-zero record-field=zero-storage+following-relocation nested-fam=zero-tail nested-fam=zero-tail'
