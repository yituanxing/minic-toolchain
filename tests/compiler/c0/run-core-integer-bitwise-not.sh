...
MINIC_CORE_IR=strict "$MINIC" -S "$work/core_integer_bitwise_not.i"     -o "$work/core_integer_bitwise_not-strict.s"
MINIC_CORE_CODEGEN=basic-v0 "$MINIC" -S "$work/core_integer_bitwise_not.i"     -o "$work/core_integer_bitwise_not-core.s"
...
"$RISCV_CC" -static -O2 "$runtime_file" "$work/core_integer_bitwise_not-core.s"     -o "$work/minic-rv64"
