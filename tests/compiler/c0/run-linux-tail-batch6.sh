#!/bin/sh
set -eu
# Batch6 validates tentative-definition -> later-definition lifecycle for static aggregate/pointer arrays.
...
printf '%s\n' 'PASS compiler/c0/linux-tail-batch6 record-array=tentative-to-definition pointer-array=incomplete-to-definition conflict=fail-closed'
