...
printf '%s\n' 'PASS compiler/c0/static_local_inferred_array element=uchar count=7 multidim-inferred=2x2 shared-ice=offsetof,array,scalar,record arithmetic=1 internal-rodata=1'
