...
work=${BUILD_DIR:-"$root/build/debug"}/tests/compiler-c0-record-length-one-array
...
printf '%s\n' 'PASS compiler/c0/record_length_one_array array-identity=1 bound=1 scalar-neighbor=1'
