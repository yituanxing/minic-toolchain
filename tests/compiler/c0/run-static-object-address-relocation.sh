...
grep -F 'array_member_nested_relocation:' "$work/static_object_address_relocation.s" >/dev/null
grep -F '.dword array_member_relocation_target+12' "$work/static_object_address_relocation.s" >/dev/null
