...
.PHONY: all help prepare check check-fast check-token-model check-lexer \
	...
	check-prefix-decrement-update check-pointer-subscripts check-const-locals \
